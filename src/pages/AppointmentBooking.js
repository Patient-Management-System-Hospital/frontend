      ...
      <div className="flex">
                    <aside className="w-1/5 bg-white p-4">
                        ...
                        <div className="mt-8 p-4 bg-gray-50 rounded-lg text-center">
                            <img src={Object} alt="Appointment Icon" className="mb-4"/>
                    ...
                    <main className="w-4/5 p-8">
                        ...
                        <div>
                            <ul className='flex items-center'>
                                <li>
                                    <Link className="text-blue-500 border-b-2 border-blue-500 pb-2 mr-8">Scheduled Appointment</Link>
                                </li>
                                <li>
                                    <Link className="text-gray-500 pb-2 mr-8">Previous Appointment</Link>
                                </li>
                                <li>
                                    <Link className="text-gray-500 pb-2 mr-8">Cancel Appointment</Link>
                                </li>
                                <li>
                                    <Link className="text-gray-500 pb-2 mr-8">Pending Appointment</Link>
                                </li>
                            </ul>
                        </div>
