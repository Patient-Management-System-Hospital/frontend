...
const AppointmentSlot = () => {
  ...
  return (
    ...
    <div className="appointment-calendar w-[1080px] ml-auto mt-10">
      ...
      {showModal && (
        <div className="modal show d-block" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel">
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form id="blockSlotForm">
                  <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="startTime" value={modalData.time} readOnly />
                  </div>
                  <div className="mb-3">
                    <label htmlFor="day" className="form-label">
                      Day
                    </label>
                    <input type="text" className="form-control" id="day" value={modalData.day.format("ddd, DD MMM")} readOnly />
                  </div>
                  <div className="mb-3">
              ...
              <div className="modal-footer bg-[#f1f1f1]">
                ...
                <button type="button" className="btn btn-primary" onClick={handleDisable}>
                  Block Slot
                </button>
              </div>
            </div>
...
// <div>
    ...
    //                   <td key={dayIndex}>
    //                     <button
    //                       className="w-full bg-[#c6c7c7] py-2"
