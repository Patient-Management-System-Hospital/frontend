                    ...
                    <main className="flex-1 bg-gray-50">
                        ...
                        <div className="p-6">
                            <div className="bg-gradient-to-r from-blue-500 to-purple-600 p-6 rounded-lg shadow-lg">
                                <h2 className="text-2xl text-white font-semibold">Profile Setting</h2>
                            </div>
                            <div className="mt-6 flex">
                                <div className="w-1/4 bg-white p-6 rounded-lg shadow-lg">
                                    ...
                                    <div className="mt-6">
                                        <h4 className="text-gray-600 font-semibold">Menu</h4>
                                        <ul className="mt-4">
                                            ...
                                            <li className="flex items-center p-3 text-blue-600 bg-blue-100 rounded-md">
                                ...
                                <div className="w-3/4 ml-6 bg-white p-6 rounded-lg shadow-lg">
                                    <h3 className="text-xl font-semibold text-gray-700">Privacy Policy</h3>
